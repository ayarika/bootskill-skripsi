    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div style="position: relative; margin-bottom: 30px;">
            ...
            <button type="button" id="toggle-pass-confirm" aria-label="Toggle Password Visibility" style="position:absolute; top: 50%; right: 10px; transform: translateY(-50%); background:transparent; border:none; cursor:pointer; color: #00000;" aria-label="Show or hide password">
                    <svg id="eye-open-confirm" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#a0a0a0ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
                        <circle cx="12" cy="12" r="3"/>
                    </svg>
                    <svg id="eye-closed-confirm" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#a0a0a0ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display:none;" aria-label="Show or hide confirm password">
                        <path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a21.27 21.27 0 0 1 5.17-5.9"/>
                        <path d="M1 1l22 22"/>
                    </svg>
            </button>
