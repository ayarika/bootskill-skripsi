    ...
    <main>
        <div class="auth-wrapper">
            <section class="auth-left">
                ...
                @php
                    $sentence= "Discover diverse training programs from all of our providers to boost your skills and career.";
            ...
            <section class="auth-right">
                <h3>Sign In</h3>
                <form method="POST" action="{{ route('signinlan.attempt') }}">
                    @csrf
                ...
                <div class="auth-footer" style="margin-top: 1px;">
                    <p>Don't have an account? <a href="/signuplan">Sign up</a></p>
                    <a href="{{ route('newpass') }}">Forgot Password?</a>
                </div>
            </section>
        </div>
    </main>
